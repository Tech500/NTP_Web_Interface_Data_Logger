////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//    Version 2.0        LittleFS version  05/21/2020 @ 16:24 EST
//
...
//
//
//  External            Note:  Required; use esp8266 by ESP8266 Community version 2.7.1 for "Arduino IDE."
//
///////////////////////////////////////////////////////////////////////////////////////////////////////
...
void getWeatherData()
{
     ...
     millibars = (pres + ((250.698 / 8.3) - 1.118));  //Relative Pressure; - 1.118 Correction to NWS, Indianapolis, IN
     currentPressure = (millibars * 0.02953);    //convert hPa to inches mercury  
     //Relative pressure in hPa = (absolute Pressure in hPa + (elevation in meters / 8.3))  //Absolute Pressure = BME280 reading in millibars 
     ...
     atm = millibars * 0.0009869233;   //Convert hPa to Atm 
